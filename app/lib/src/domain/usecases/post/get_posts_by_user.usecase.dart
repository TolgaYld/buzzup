...
class GetPostsByUserUsecase extends UsecaseWithParams<List<PostEntity>, String> {
  const GetPostsByUserUsecase(this._repo);
  final PostRepo _repo;

  @override
  ResultFuture<List<PostEntity>> call(String params) async => await _repo.getPostsByUser(params);
}
