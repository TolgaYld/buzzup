                            ...
                            <tbody>
                              <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;padding-top:100px;padding-bottom:50px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#005fb0;"><span style="font-size: 21px; line-height: 21px;">One more step to complete the registration!</span><br /></div>
                                </td>
                              </tr>
                              <tr>
